...
namespace SocialSpreadSheet
{
    ...
    public abstract class AbstractSpreadsheet
    {
        ...
        ///     equal.
        /// </summary>
        protected AbstractSpreadsheet(Func<string, bool> isValid, Func<string, string> normalize, string version)
        {
            IsValid = isValid;
            Normalize = normalize;
            Version = version;
        ...
        /// </summary>
        protected Func<string, bool> IsValid { get; private set; }
        ...
        /// </summary>
        protected Func<string, string> Normalize { get; private set; }
        ...
        /// </summary>
        private IEnumerable<String> GetCellsToRecalculate(IEnumerable<string> names)
        {
